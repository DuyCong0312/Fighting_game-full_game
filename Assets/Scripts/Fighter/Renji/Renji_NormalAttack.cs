...
public class Renji_NormalAttack : MonoBehaviour
{
    ...
    private void ActiveRenjiFirstAttack()
    {
        StartCoroutine(AttackMoveEnum(firstAttackForce, moveTime));
    }

    private void ActiveRenjiSecondAttack()
    {
        StartCoroutine(AttackMoveEnum(secondAttackForce, moveTime));
    }

    private void ActiveRenjiThirdAttack()
    {
        StartCoroutine(AttackMoveEnum(thirdAttackForce, moveTime * 2));
    }
}
