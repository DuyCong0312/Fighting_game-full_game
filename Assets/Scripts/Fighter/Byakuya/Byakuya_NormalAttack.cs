...
public class Byakuya_NormalAttack : MonoBehaviour
{
    ...
    private void ActiveByakuyaFirstAttack()
    {
        StartCoroutine(AttackMoveEnum(firstAttackForce, moveTime));
    }

    private void ActiveByakuyaSecondAttack()
    {
        StartCoroutine(AttackMoveEnum(secondAttackForce, moveTime));
    }

    private void ActiveByakuyaThirdAttack()
    {
